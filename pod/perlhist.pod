...
=head1 THE RECORDS
 ...
 rurban    5.22.4c      2016-Jul-27
 rurban    5.22.5c      2018-Jan-01
 ...
 rurban    5.25.0c      2016-Aug-07
 rurban    5.25.1c      2016-Oct-16
 rurban    5.25.2c      2016-Dec-13
 ...
 rurban    5.27.0c      2017-May-17
 rurban    5.27.1c      2017-Aug-15
 rurban    5.27.2c      2017-Dec-05
...
Size in memory measured with massif for B<perl -e0> for most major
releases, non-threaded. (I<m0>)
...
For B<perl -MConfig -Mstrict -Mwarnings -V:ccflags> (I<p0>):

  release       memory usage
  ==========================
  5.6.2d	673653  (w/ DEBUGGING)
  5.8.4d	684487  (w/ DEBUGGING)
  5.8.5d	753069  (w/ DEBUGGING)
  5.8.8		666789
  5.10.1	617331
  5.12.5	656194
  5.14.4	718838
...
With unicode: B<perl -C -E'use utf8; my $s="x≈x"; $s=~s/a≈e//i;'> (I<p1>):

  release       memory usage
  ==========================
  5.6.2d	 787375  (w/ DEBUGGING)
  5.8.4d	1225683  (w/ DEBUGGING)
  5.8.5d	1400612  (w/ DEBUGGING)
  5.8.8		1357073
  5.10.1	1343506
  5.12.5	1693931
  5.14.4	1719327
  ...
  5.28.0c	228825
    ...
    valgrind --tool=massif --massif-out-file=massif.$r ...
    grep -h mem_heap_B= massif.$r |cut -c12-|sort -rn|head -n1
...
the Perl source distribution for somewhat more selected releases.
 ...
 Configure    593      1       599      1
 Cross        122     15       118     15
 djgpp         21      7        17      7
 h2pl          24     15        12     15
 hints        376     87       355     85
 NetWare      499     61       462     61
 os2          552     70       509     70
 plan9        322     17       304     17
 Porting     1380     73      1490     85
 qnx            5      4         1      4
 symbian      315     54       292     54
 utils        578     50       242     26
 vms          527     12       523     12
 vos           12      7         8      7
 win32       1313     65      1316     64
