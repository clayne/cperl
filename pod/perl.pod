...
aux c2ph h2ph h2xs cperlbug pl2pm pod2html pod2man splain xsubpp
...
=head2 Miscellaneous
    ...
    perlcdelta		cperl changes in version 5.29.2c
    ...
    perl5244cdelta	cperl changes in version 5.24.4c
    perl5243cdelta	cperl changes in version 5.24.3c
    ...
    perl5225cdelta	cperl changes in version 5.22.5c
...
cperl is developed by Reini Urban <rurban@cpan.org>.
...
For Perl5 you may mail your bug reports (be sure to include full configuration
information as output by the myconfig program in the perl source
tree, or by C<perl -V>) to perlbug@perl.org .  If you've succeeded
in compiling perl, the C<perlbug> script in the F<utils/> subdirectory
can be used to help mail in a bug report.
For B<cperl> either use the L<cperlbug> script or file an issue at the
L<https://github.com/perl11/cperl> repository.
